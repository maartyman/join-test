...
import {DualKeyArrayObjectCount} from "./DualKeyArrayObjectCount";

export class TwoObjectIndexedCount extends JoinIterator {
  readonly left: DualKeyArrayObjectCount<Binding>;
  readonly right: DualKeyArrayObjectCount<Binding>;
  ...
  constructor(right: Iterator, left: Iterator, leftIndex: number, rightIndex: number) {
    ...
    this.left = new DualKeyArrayObjectCount();
    this.right = new DualKeyArrayObjectCount();
  ...
  public next(): Binding | undefined {
    ...
    let activeMap: DualKeyArrayObjectCount<Binding>;
    let otherMap: DualKeyArrayObjectCount<Binding>;
