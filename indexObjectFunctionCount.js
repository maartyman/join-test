...
exports.TwoObjectIndexedCount = void 0;
const types_1 = require("./types");
const DualKeyArrayObjectCount_1 = require("./DualKeyArrayObjectCount");
class TwoObjectIndexedCount extends types_1.JoinIterator {
    constructor(right, left, leftIndex, rightIndex) {
        ...
        this.left = new DualKeyArrayObjectCount_1.DualKeyArrayObjectCount();
        this.right = new DualKeyArrayObjectCount_1.DualKeyArrayObjectCount();
        this.results = [];
    }
...
exports.TwoObjectIndexedCount = TwoObjectIndexedCount;
//# sourceMappingURL=indexObjectFunctionCount.js.map